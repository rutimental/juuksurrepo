...
public class Salong {
	...
	public static void main(String[] args) {
		...
		System.out.println("Pasol Nahhui :)?");
		String sKasVarvime = TextIO.getlnString();
		
		if (sKasVarvime.equals("Jah")){
			System.out.println("Davai värvime:"+varv.juuksev2rv()); // 
		}else{System.out.println("Davai siis tõmba nahhui");}
		
		
		while (true) {
			
			System.out.println("Sisesta kaardi nimi (Gold, Silver või puudub) : ");
			
			liige = Visiitkaart(); // liige saab uue väärtuse läbi Visiitkaart meetodi
			...
			if (liige.equals("puudub")) {
				...
				System.out.println("Kliendikaarti ei sisestatud, soodustused puuduvad.");
